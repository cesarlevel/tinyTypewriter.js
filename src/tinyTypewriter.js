function tinyTypewriter(
  ...
  function checkElPos() {
    ...
    if (
      elPosition.bottom <= window.innerHeight - startOnViewOffset &&
      elPosition.top >= 0 + startOnViewOffset
    ) {
  ...
  if (
    startOnView &&
    !(elPosition.bottom <= window.innerHeight && elPosition.top >= 0)
  ) {
